...
class ServiceResource extends Resource
{
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make(trans('nova-portfolio::messages.forms.service_name'), 'name')
                ->sortable()
                ->rules('required', 'max:255'),

            Textarea::make(trans('nova-portfolio::messages.forms.service_overview'), 'overview')->hideFromIndex(),

            Select::make(trans('nova-portfolio::messages.forms.service_icon'), 'icon')
                ->options(ServiceModel::icons()),
    ...
    public static function label() {
        return trans('nova-portfolio::messages.resources.service_label');
    }
}
